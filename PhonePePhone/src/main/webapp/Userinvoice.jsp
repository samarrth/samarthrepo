...
%>
    <div class="invoice-container">
        ...
        try
        {
            ...
            PreparedStatement pstmt = con.prepareStatement("select * from orderdetails.details where email = ? and status In('bill','Cancelled','Delivered') and orderid = ?");
    ...
    <% } %>
   		...
   		<span><b>status:</b>Your order has been <%=rs.getString(17) %></span>
       ...
       <button name = "checkout" onclick="window.location.href='profiledetails.jsp'">Back</button>

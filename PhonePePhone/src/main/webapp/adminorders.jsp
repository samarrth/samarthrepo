				...
				<div class="table-container">
					<table>
						...
						try {
							...
							ResultSet rs = stmt.executeQuery("SELECT * FROM orderdetails.details where status = 'bill'");
							while (rs.next()) {
						%>
						<tr>
						...
						<form action="adminorderaction.jsp" method = "post">
						<input type = "hidden" name = "id" value = "<%=rs.getInt(19)%>">
						<input type = "hidden" name = "email" value = "<%=rs.getString(14)%>">
						<input type = "hidden" name = "status" value = "Delivered">
						<button type = "submit" class="updateicon"><i class="fa-solid fa-pen-to-square"></i></button>
						</form>
						<form action="adminorderaction.jsp" method = "post">
						...
						<button type = "submit" class="deleteicon"><i class="fa-solid fa-trash"></i></button>
						</form>
						</td>
						</tr>
						<%}
